...
import 'package:flutter_Aosan_ecommerce/provider/auth_provider.dart';
...
class CartBottomSheetOrg extends StatefulWidget {
  final Product product;
  final Function callback;
  CartBottomSheetOrg({@required this.product, this.callback});

  @override
  _CartBottomSheetOrgState createState() => _CartBottomSheetOrgState();
}

class _CartBottomSheetOrgState extends State<CartBottomSheetOrg> {
