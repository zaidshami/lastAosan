      ...
      child: Consumer<ProductDetailsProvider>(
        builder: (context, details, child) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Column(children: [
                ...
                Text('${PriceConverter.convertPrice(context, _startingPrice)}'
                  ...
                  style: titilliumRegular1.copyWith(color: Theme.of(context).hintColor,
           ...
           ///the discounted price
            Text(productModel.desc ?? '',
             ...
             /// the row of the old color list
             //   Row(children: [
          //     // Text('${details.reviewList != null ? details.reviewList.length : 0} ${getTranslated("reviews", context)} | ',
          //     //     style: titilliumRegular.copyWith(color: Theme.of(context).hintColor,
          //     //       fontSize: Dimensions.FONT_SIZE_DEFAULT,)),
          //
          //     // Text('${details.orderCount} ${getTranslated("ORDER", context)} | ', style: titilliumRegular.copyWith(
          //     //   color: Theme.of(context).hintColor,
          //     //   fontSize: Dimensions.FONT_SIZE_DEFAULT,
          //     // )),
          //
          //     // Text('${details.wishCount} ${getTranslated("wish", context)}', style: titilliumRegular.copyWith(
          //     //   color: Theme.of(context).hintColor,
          //     //   fontSize: Dimensions.FONT_SIZE_DEFAULT,
          //     // )),
          //
          ...
          //   ]),
            ...
            /// the  old colors of the products
