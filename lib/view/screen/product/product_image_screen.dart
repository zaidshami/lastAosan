...
class _ProductImageScreenState extends State<ProductImageScreen> {
 ...
 // PageController _pageController2 = PageController(initialPage: Provider.of<ProductDetailsProvider>(context, listen: false).imageSliderIndex);
              ...
              PhotoViewGallery.builder(
                ...
                builder: (BuildContext context, int index) {
                  return PhotoViewGalleryPageOptions(
                    ...
                    imageProvider: NetworkImage(      '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productImageUrl}/${Product().productFrontImage[index]}',),
