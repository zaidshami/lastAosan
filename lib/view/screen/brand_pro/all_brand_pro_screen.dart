...
import '../home/widget/brand_pro_view.dart';
import '../home/widget/brand_view.dart';

class AllBrandProScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton(
            ...
            onSelected: (value) {
              Provider.of<BrandProProvider>(context, listen: false).sortBrandLis(value);
            },
          )],
      ),
      ...
      body: Padding(
        ...
        child: BrandProView(isHomePage: false),
      ),
    );
  }
}
