...
import '../../../../view/basewidget/textfield/custom_password_textfield.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  _updateSocialUserAccount() async {
  ...
  _updateUserAccount() async {
    String _firstName = await _firstNameController.text.trim();
    String _lastName = await _firstNameController.text.trim();
    String _email = _emailController.text.trim();
    String _phoneNumber = _phoneController.text.trim();
    String _password = _passwordController.text.trim();
    String _confirmPassword = _confirmPasswordController.text.trim();
                  ...
                  Expanded(child: Container(
                    ...
                    child: ListView(physics: BouncingScrollPhysics(),
                      children: [
                        ...
                        /// password
                        Provider.of<ProfileProvider>(context,listen: false).userMedium == 'apple'  || Provider.of<ProfileProvider>(context,listen: false).userMedium=='facebook' || Provider.of<ProfileProvider>(context,listen: false).userMedium == 'google'?
                       SizedBox():  Container(
                          margin: EdgeInsets.only(
                              top: Dimensions.MARGIN_SIZE_DEFAULT,
                              left: Dimensions.MARGIN_SIZE_DEFAULT,
                        ...
                        ///reinter the password

                        Provider.of<ProfileProvider>(context,listen: false).userMedium == 'apple'  ||   Provider.of<ProfileProvider>(context,listen: false).userMedium=='facebook' || Provider.of<ProfileProvider>(context,listen: false).userMedium == 'google'

                            ?
                        SizedBox():  Container(margin: EdgeInsets.only(
                            top: Dimensions.MARGIN_SIZE_DEFAULT,
                            left: Dimensions.MARGIN_SIZE_DEFAULT,
                            right: Dimensions.MARGIN_SIZE_DEFAULT),
                          child: Column(children: [
