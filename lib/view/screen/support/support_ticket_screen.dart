...
import '../../../../view/screen/support/support_conversation_screen.dart';
...
class SupportTicketScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomExpandedAppBar(
      ...
      bottomChild: InkWell(
        onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => IssueTypeScreen())),
            ...
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => SupportConversationScreen(
