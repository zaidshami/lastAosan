      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Consumer<CartProvider>(
          builder: (context, order, child) {
            ...
            order.shippingList[widget.sellerIndex].shippingMethodList.length != 0 ?  SizedBox(
              height: 300,
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return RadioListTile(
                    title: Text('${order.shippingList[widget.sellerIndex].shippingMethodList[index].title}\n (المدة : ${order.shippingList[widget.sellerIndex].shippingMethodList[index].duration + " يوم "}, التكلفة : ${
