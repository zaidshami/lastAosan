          ...
          Expanded(child: TextButton(
            onPressed: () {
              if(isCurrency) {
                ...
                Provider.of<BrandProvider>(context, listen: false).getBrandList(1,true, context);
                Provider.of<ProductProvider>(context, listen: false).getLatestProductList(Provider
                    .of<CategoryProvider>(context)
                    .categoryList[Provider.of<CategoryProvider>(context).categorySelectedIndex]
                    .id,1, context, reload: true);
                Provider.of<ProductProvider>(context, listen: false).getFeaturedProductList(Provider
                    .of<CategoryProvider>(context)
                    .categoryList[Provider.of<CategoryProvider>(context).categorySelectedIndex]
                    .id,"1",context, reload: true);
                Provider.of<FeaturedDealProvider>(context, listen: false).getFeaturedDealList(Provider
                    .of<CategoryProvider>(context)
                    .categoryList[Provider.of<CategoryProvider>(context).categorySelectedIndex]
                    .id,true, context);
                Provider.of<ProductProvider>(context, listen: false).getLProductList(Provider
                    .of<CategoryProvider>(context)
                    .categoryList[Provider.of<CategoryProvider>(context).categorySelectedIndex]
                    .id,'1', context, reload: true);
              }
