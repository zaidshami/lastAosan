        ...
        if(Provider.of<SplashProvider>(context,listen: false).configModel.emailVerification){
          Provider.of<AuthProvider>(context, listen: false).checkEmail(_emailController.text.toString(),
            ...
            if (value.isSuccess) {
              ...
              Navigator.pushAndRemoveUntil(context, CupertinoPageRoute(builder: (_) => VerificationScreen(
          ...
          Navigator.pushAndRemoveUntil(context, CupertinoPageRoute(builder: (_) => MobileVerificationScreen(
            ...
            Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [Row(children: [
                  ...
                  InkWell(
                    onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => ForgetPasswordScreen())),
...
defaultTargetPlatform == TargetPlatform.android &&AppConstants.showLogin == true ?SocialLoginWidget():SizedBox(),
defaultTargetPlatform == TargetPlatform.iOS &&AppConstants.showLoginApple == true ? SocialLoginWidget() :SizedBox(),
            ...
            GestureDetector(
              onTap: () {
                if (!Provider.of<AuthProvider>(context, listen: false).isLoading) {
                  ...
                  Navigator.pushAndRemoveUntil(context, CupertinoPageRoute(builder: (_) => DashBoardScreen()),
                          (route) => false);
                }
              },
              child: Container(
                margin: EdgeInsets.only(left: Dimensions.MARGIN_SIZE_AUTH, right: Dimensions.MARGIN_SIZE_AUTH,top: 4
                   ),
