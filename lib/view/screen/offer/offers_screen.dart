...
class OffersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Provider.of<BannerProvider>(context, listen: false).getFooterBannerList(Provider
    ...
    return CustomExpandedAppBar(title: getTranslated('offers', context), child: Consumer<BannerProvider>(
      builder: (context, banner, child) {
        return banner.footerBannerList != null ? banner.footerBannerList.length != 0 ? RefreshIndicator(
          ...
          onRefresh: () async {
            await Provider.of<BannerProvider>(context, listen: false).getFooterBannerList(Provider
                .of<CategoryProvider>(context)
                .categoryList[Provider.of<CategoryProvider>(context).categorySelectedIndex]
                .id,context);
          },
