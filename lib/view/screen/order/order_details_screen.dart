...
import '../../../../view/basewidget/shimmer_loading.dart';
import '../../../../view/screen/chat/chat_screen.dart';
import '../../../../view/screen/seller/seller_screen.dart';
...
import '../../../../view/basewidget/amount_widget.dart';
...
import '../../../../view/screen/order/widget/order_details_widget.dart';
import '../../../../view/screen/payment/payment_screen.dart';
import '../../../../view/screen/support/support_ticket_screen.dart';
import '../../../../view/screen/tracking/tracking_screen.dart';
                        ...
                        return Container(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                /// the header of the seller and chatting with him
                                // InkWell(
                                //   onTap: () {
                                ...
                                //   },
                                //
                                //   child: sellerList[index] == 1? SizedBox(): InkWell(
                                //     onTap: (){
                                //
                                //       ///here we go to the chat screen of the seller
                                //
                                ...
                                //       sellerList[index].toString() :Provider.of<SellerProvider>(context).orderSellerList[index].seller==null?""
                          ...
                          children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  ...
                                  (order.trackingModel.paymentStatus == "unpaid" ? " غير مدفوع ":  " مدفوع") : 'Digital Payment',
                                    style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL),
                                  ),
                                ]),
                            SizedBox(height: Dimensions.MARGIN_SIZE_EXTRA_SMALL),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Text(getTranslated('PAYMENT_PLATFORM', context),
                                  style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)),
                           ///(order.trackingModel.paymentMethod == "cash on delivery" ? " دفع الكتروني":  " الدفع عند الاستلام")
                              ...
                              InkWell(onTap: () async {
                                ...
                                Navigator.pushReplacement(context,
                                    CupertinoPageRoute(builder: (_) => PaymentScreen(
                                      customerID: userID,
                                      couponCode: '',
                              ...
                              (order.trackingModel.paymentMethod == "cash on delivery" ? " دفع الكتروني":  " الدفع عند الاستلام"): 'Digital Payment',
                      ...
                      child: Row(children: [Expanded(child: orderModel != null &&
                        ...
                        CustomButton(buttonText: getTranslated('TRACK_ORDER', context),
                          onTap: () => Navigator.of(context).push(
                              CupertinoPageRoute(builder: (context) => TrackingScreen(orderID: orderId.toString()))),),),
                        SizedBox(width: Dimensions.PADDING_SIZE_SMALL),

                        /// support center bottoms
                        Expanded(child: SizedBox(height: 45,
                          child: TextButton(
                            onPressed: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => SupportTicketScreen())),
