...
class CartProvider extends ChangeNotifier {
  ...
  Future getCartData() async {
   ...
   cart.productModel.image != null ? productImageCart =  await cart.productModel.image: null ;
...
void setQtyOutTrue (){
  ...
  Future<ApiResponse> getCartDataAPI(BuildContext context) async {
   // productImageCart = cart.productModel.image;
  ...
  Future<ApiResponse> addToCartAPI(CartModel cart, Function callback, BuildContext context,) async {
    _isLoading = true;
    notifyListeners();
    ApiResponse apiResponse = await cartRepo.addToCartListData(cart);
    _isLoading = false;
    if (apiResponse.response != null && apiResponse.response.statusCode == 200) {
