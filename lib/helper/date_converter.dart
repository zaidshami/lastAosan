...
class DateConverter {
  ...
  static String localDateToIsoStringAMPM1(DateTime dateTime) {
    return DateFormat('a h:mm | yyyy-MM-dd ').format(dateTime.toLocal());
  }
  // static String localDateToIsoStringAMPM1(DateTime dateTime) {
  //   return DateFormat('a h:mm | yyyy-MM-dd ').format(dateTime);
  // }
