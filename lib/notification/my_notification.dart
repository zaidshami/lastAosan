      ...
      try{
        if(payload != null && payload.isNotEmpty) {
          MyApp.navigatorKey.currentState.push(
              CupertinoPageRoute(builder: (context) => OrderDetailsScreen(orderModel: null, orderId: int.parse(payload),orderType: 'default_type',)));
        }
      }catch (e) {}
      return;
    });
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      ...
      try{
        if(message.notification.titleLocKey != null && message.notification.titleLocKey.isNotEmpty) {
          MyApp.navigatorKey.currentState.push(
              CupertinoPageRoute(builder: (context) => OrderDetailsScreen(orderModel: null, orderId: int.parse(message.notification.titleLocKey),orderType: 'default_type',)));
        }
      }catch (e) {}
    });
  }
